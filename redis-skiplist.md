...
[![](http://idiotsky.top/images/redis-skiplist.png)](http://idiotsky.top/images/redis-skiplist.png)
...
[![](http://idiotsky.top/images/redis-skiplist-1.png)](http://idiotsky.top/images/redis-skiplist-1.png)
...
[![](http://idiotsky.top/images/redis-skiplist-2.png)](http://idiotsky.top/images/redis-skiplist-2.png)
...
[![](http://idiotsky.top/images/redis-skiplist-3.png)](http://idiotsky.top/images/redis-skiplist-3.png)
再举个例子， 图 5-5 用虚线标记了在跳跃表中查找分值为 2.0 、 成员对象为 o2 的节点时， 沿途经历的层： 在查找节点的过程中， 程序经过了两个跨度为 1 的节点， 因此可以计算出， 目标节点在跳跃表中的排位为 2 。
[![](http://idiotsky.top/images/redis-skiplist-4.png)](http://idiotsky.top/images/redis-skiplist-4.png)
...
[![](http://idiotsky.top/images/redis-skiplist-5.png)](http://idiotsky.top/images/redis-skiplist-5.png)
...
[![](http://idiotsky.top/images/redis-skiplist-6.png)](http://idiotsky.top/images/redis-skiplist-6.png)

# 跳跃表
虽然仅靠多个跳跃表节点就可以组成一个跳跃表， 如图 5-8 所示。
[![](http://idiotsky.top/images/redis-skiplist-7.png)](http://idiotsky.top/images/redis-skiplist-7.png)
但通过使用一个 zskiplist 结构来持有这些节点， 程序可以更方便地对整个跳跃表进行处理， 比如快速访问跳跃表的表头节点和表尾节点， 又或者快速地获取跳跃表节点的数量（也即是跳跃表的长度）等信息， 如图 5-9 所示。
[![](http://idiotsky.top/images/redis-skiplist-8.png)](http://idiotsky.top/images/redis-skiplist-8.png)
zskiplist 结构的定义如下：
````c
